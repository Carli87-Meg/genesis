"""Cattura GUI TavolaCoperchio + still coperchio/staffa-asola, nomi NUOVI."""
...
def main():
    copies = {
        "coperchio-iso-01.jpg": os.path.join(EXPORT, "Coperchio.jpg"),
        "coperchio-schizzo-base-01.jpg": os.path.join(EXPORT, "Coperchio-schizzo.jpg"),
        "coperchio-schizzo-fori-01.jpg": os.path.join(EXPORT, "Coperchio-schizzo-2.jpg"),
        "coperchio-schizzo-maniglia-01.jpg": os.path.join(EXPORT, "Coperchio-schizzo-3.jpg"),
        "staffa-asola-iso-01.jpg": os.path.join(EXPORT, "StaffaAsolaSmall.jpg"),
        "staffa-asola-schizzo-01.jpg": os.path.join(EXPORT, "StaffaAsolaSmall-schizzo.jpg"),
        "staffa-asola-asola-01.jpg": os.path.join(EXPORT, "StaffaAsolaSmall-schizzo-2.jpg"),
    }
    ...
    hwnd, title = find_sw_hwnd("TavolaCoperchio")
    if hwnd is None:
    ...
    save_all("coperchio-tavola-01.jpg", img)
    save_all("coperchio-cartiglio-01.jpg", zoom)
