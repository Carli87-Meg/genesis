"""Cattura GUI TavolaPiastraSupporto + copia still schizzi con nomi NUOVI."""
...
def main():
    copies = {
        "piastra-supporto-iso-01.jpg": os.path.join(EXPORT, "PiastraSupporto.jpg"),
        "piastra-supporto-schizzo-base-01.jpg": os.path.join(EXPORT, "PiastraSupporto-schizzo.jpg"),
        "piastra-supporto-schizzo-tasca-01.jpg": os.path.join(EXPORT, "PiastraSupporto-schizzo-2.jpg"),
        "piastra-supporto-schizzo-nervatura-01.jpg": os.path.join(EXPORT, "PiastraSupporto-schizzo-3.jpg"),
        "piastra-supporto-schizzo-fori-01.jpg": os.path.join(EXPORT, "PiastraSupporto-schizzo-4.jpg"),
    }
    ...
    save_all("piastra-supporto-tavola-01.jpg", img)
    save_all("piastra-supporto-cartiglio-01.jpg", zoom)
