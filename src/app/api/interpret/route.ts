...
Any other request (coperchio, maniglia, asola, new plate, bushing, pin, cylinder, assembly, drawing): compile the user's geometry with NEW PascalCase names. Never reuse StaffaFissaggio, BoccolaGuida, AssiemeStaffa, PiastraSupporto, BasePiastra100, BoccolaCentrale, Piastra90, FiancataSx, LongheroneSx, Piastra100x60, Cubo20, AssemblePiastraCubo, PiastraOrizzontale, PiastraVerticale.
