...
Any other request (coperchio, maniglia, asola, new plate, bushing, pin, shaft, cylinder, assembly, drawing, telaio a U): compile the user's geometry with NEW PascalCase names. Never reuse StaffaFissaggio, BoccolaGuida, AssiemeStaffa, PiastraSupporto, BasePiastra100, BoccolaCentrale, Piastra90, FiancataSx, LongheroneSx, Piastra100x60, Cubo20, AssemblePiastraCubo, PiastraOrizzontale, PiastraVerticale, Piastra80x50, Cilindro20x30, AssemblePiastraCilindro, BoccolaFlangia16, PiastraForo16, AssemieBoccolaPiastra, AlberoSpallamento10, PiastraForo10, AssiemeAlberoPiastra.
